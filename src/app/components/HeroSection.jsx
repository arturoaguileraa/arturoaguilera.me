        ...
        >
          <h1 className="text-white mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
            ...
            <TypeAnimation
              ...
              repeat={Infinity}
              className={({ text }) => {
                // Condicional para cambiar el tamaño de la fuente según el texto
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-fit sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            <Link
